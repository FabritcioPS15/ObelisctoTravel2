...
export function Header() {
  ...
  const navigation = [
    ...
    { name: tr.nav.about, href: "/nosotros" },
    {
      ...
      submenu: [
        { name: tr.transporte?.heroBadge || "Transporte", href: "/servicios/transporte" },
        { name: tr.nav.tours, href: "/tours" },
        { name: locale === "en" ? "Hotel reservations" : locale === "pt" ? "Reservas de hotéis" : "Reservas de hoteles", href: "/hoteles" },
      ],
    },
